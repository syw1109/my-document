...
# 시작가가 ma20 *1.02 이하이면 low ma20*0.98 까지 안팔리는 조건 추가
...
while True:
    try:
        ...
        if open_price < ma20*1.02 or open_price < ma30*1.02:
            if low_price > ma20*0.98 and low_price > ma30*0.98 and open_price > ma20 and open_price > ma30:  
                if end_time1 < now :
                    if eth < 0.01:
                        if btc < 0.0005:
        ...
        if open_priceE < ma20E*1.025 or open_priceE < ma30E*1.025:
            ...
            if low_priceE > ma20E*0.975 and low_priceE > ma30E*0.975 and open_priceE > ma20E and open_priceE > ma30E:
                if end_time < now :
