...
# 흰 영역 클릭
# pyautogui.click(300, 300, duration=0.5)  # 절대좌표를 입력

btn_brush = pyautogui.locateOnScreen("btn_brush.png") # 버튼 브러시를 기준으로 상대좌표를 찾아감
pyautogui.click(btn_brush.left - 200, btn_brush.top + 200) #버튼 브러쉬의 왼쪽 -200, 탑에서 200내려오게 해서 클릭하는 상대좌표
